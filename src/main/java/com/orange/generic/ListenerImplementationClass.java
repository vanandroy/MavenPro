...
//	}
		try {
			String screenshotname=WebDriverUtility.getScreenShot(OrangeHRMBaseClass.sdriver,result.getMethod().getMethodName());
	...
	public void onStart(ITestContext context) {
		...
		htmlReport.config().setDocumentTitle("project Orange HRM");
